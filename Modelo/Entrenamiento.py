...
if __name__ == "__main__":
    ...
    for epoch in range(1, NUM_EPOCHS + 1):
        ...
        if val_loss < best_val:
            ...
            print(f"  -> Mejor modelo actualizado y guardado en: {ruta_guardado}")

    print("Entrenamiento finalizado.")
    print("\nGenerando gráfica de evolución del entrenamiento...")
    ...
    print(f"¡Gráfica generada con éxito y guardada en el directorio como '{nombre_archivo}'!")